<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterEmployee.aspx.cs" Inherits="EmployeeManagementPayrollSystem.Pages.Aspx.RegisterEmployee" %>
...
<body>
    ...
    <div class="form" action="#" runat="server">
        <div class="row">
            ...
            <asp:TextBox class="input" type="text" id="name" name="name" runat="server" placeholder="Your name.." ></asp:TextBox>
        </div>
         <div class="row">
            <label class="label text" for="profile">Profile image</label>
            <div class="profile-radio-button">
                <label>
                    <asp:RadioButton runat="server" ID="profile1" GroupName="profile" value="image1" />
                    <asp:Image runat="server" class="profile" ID='image1' src="../Assets/Ellipse -3.png" />
                </label>
                <label>
                    <asp:RadioButton runat="server"  ID="profile2" GroupName="profile" value="image2" />
                    <asp:Image runat="server" class="profile" ID='image2' src="../Assets/Ellipse -1.png" />
                </label>
                <label>
                    <asp:RadioButton runat="server"  ID="profile3" GroupName="profile" value="image3" />
                    <asp:Image runat="server" class="profile" ID='image3' src="../Assets/Ellipse -8.png" />
                </label>
                <label>
                    <asp:RadioButton runat="server"  ID="profile4" GroupName="profile" value="image4"/>
        ...
        <div class="row">
            ...
            <div>
                <asp:CheckBox class="checkbox" type="checkbox"  AutoPostBack="True" id="hr" name="hr" runat="server" />
                <label class="text" for="hr">HR</label>
                <asp:CheckBox class="checkbox" type="checkbox" AutoPostBack="True"  id="sales" name="sales"  runat="server" />
                <label class="text" for="sales">Sales</label>
                <asp:CheckBox class="checkbox" type="checkbox" AutoPostBack="True"  id="finance" name="finance"  runat="server" />
                <label class="text" for="finance">Finance</label>
                <asp:CheckBox class="checkbox" type="checkbox" AutoPostBack="True" id="engineer" name="engineer"  runat="server" />
                <label class="text" for="engineer">Engineer</label>
                <asp:CheckBox class="checkbox" type="checkbox" AutoPostBack="True"  id="others" name="others"  runat="server" />
        ...
        <div class="buttonParent">
            ...
            <div class="submit-reset">
                 <asp:Button Text="Submit" runat="server" class="button submitButton" OnClick="SubmitButton"/>
                <asp:Button Text="Reset" runat="server"  class="resetButton button" OnClick="ResetButton"/>
            </div>
        </div>
